...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val savedUser = userRepository.save(User("backtony", null))
        val request = BookLoanRequest("backtony", "이상한 나라의 엘리스")
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("backtony", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 엘리스"))
        val request = BookReturnRequest("backtony", "이상한 나라의 엘리스")
